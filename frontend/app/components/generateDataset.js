                  ...
                  <form id="generate-dataset-form" onSubmit={formHandler}>
                    <div className="space-y-5">
                      ...
                      <div className="flex items-center gap-x-3">
                        ...
                        />
                        <label htmlFor="forTesting" className="text-sm font-medium text-gray-900">For Testing</label>
                      </div>

                      <div>
                        <label htmlFor="sampleNumber" className={theme.classes.label}>
                          Samples per Label (Training + Validation)
                        </label>
                        <input
                          id="sampleNumber"
                          name="sampleNumber"
