  ...
  switch (req.method) {
    case 'GET':
      try {
        ...
        const response = await api.get(`api/feature_extractor/trainingsession/`, { params: { status } });
    ...
    case 'POST':
      try {
        ...
        const response = await api.post(`api/feature_extractor/trainingsession/`, postData);
        const data = response.data;
